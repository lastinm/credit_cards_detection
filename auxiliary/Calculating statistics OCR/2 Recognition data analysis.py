...
# 2. Топ-10 ошибок для каждого класса. Пишем в файл top_false/top10_errors.txt
# 3. Анализ условно точных совпадений. Пишем в файл top_false/problem_accuracy.txt
# 4. Сохранение изображений для Топ-10 ошибочных распознаваний по каждому фреймворку и классу. Путь сохранения top_false/
